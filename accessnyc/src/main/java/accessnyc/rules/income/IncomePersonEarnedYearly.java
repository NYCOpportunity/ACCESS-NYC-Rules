...
public class IncomePersonEarnedYearly implements java.io.Serializable
{
   ...
   public IncomePersonEarnedYearly()
   {
   }
   ...
   public IncomePersonEarnedYearly(accessnyc.request.Person person,

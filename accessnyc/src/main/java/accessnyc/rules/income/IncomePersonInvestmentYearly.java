...
public class IncomePersonInvestmentYearly implements java.io.Serializable
{
   ...
   public IncomePersonInvestmentYearly()
   {
   }
   ...
   public IncomePersonInvestmentYearly(accessnyc.request.Person person,

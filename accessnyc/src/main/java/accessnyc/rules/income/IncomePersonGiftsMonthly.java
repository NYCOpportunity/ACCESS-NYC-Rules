...
public class IncomePersonGiftsMonthly implements java.io.Serializable
{
   ...
   public IncomePersonGiftsMonthly()
   {
   }
   ...
   public IncomePersonGiftsMonthly(accessnyc.request.Person person,

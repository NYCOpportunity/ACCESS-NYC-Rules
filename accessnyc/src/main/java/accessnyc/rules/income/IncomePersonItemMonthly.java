...
public class IncomePersonItemMonthly implements java.io.Serializable
{
   ...
   public IncomePersonItemMonthly()
   {
   }
   ...
   public IncomePersonItemMonthly(accessnyc.request.Person person,

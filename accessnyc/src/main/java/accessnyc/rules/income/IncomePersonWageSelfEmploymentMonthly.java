...
public class IncomePersonWageSelfEmploymentMonthly implements java.io.Serializable
{
   ...
   public IncomePersonWageSelfEmploymentMonthly()
   {
   }
   ...
   public IncomePersonWageSelfEmploymentMonthly(accessnyc.request.Person person,

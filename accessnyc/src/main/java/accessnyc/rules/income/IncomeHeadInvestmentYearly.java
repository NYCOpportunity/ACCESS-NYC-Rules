...
public class IncomeHeadInvestmentYearly implements java.io.Serializable
{
   ...
   public IncomeHeadInvestmentYearly()
   {
   }
   ...
   public IncomeHeadInvestmentYearly(accessnyc.request.Person person,

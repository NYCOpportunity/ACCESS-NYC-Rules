...
public class ExpensePersonItemMonthly implements java.io.Serializable
{
   ...
   public ExpensePersonItemMonthly()
   {
   }
   ...
   public ExpensePersonItemMonthly(accessnyc.request.Person person,
